...
public class MapcBikeFlagEncoder extends BikeCommonFlagEncoder {
    ...
    public MapcBikeFlagEncoder(PMap properties) {
        this(
    ...
    public MapcBikeFlagEncoder(String propertiesStr) {
        this(new PMap(propertiesStr));
    }

    public MapcBikeFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
