 ...
 * @author Peter Karich
 */
public class SecondMapcBikeFlagEncoder extends BikeCommonFlagEncoder {
    public SecondMapcBikeFlagEncoder() {
        this(4, 2, 0);
    }

    public SecondMapcBikeFlagEncoder(PMap properties) {
        this(
    ...
    public SecondMapcBikeFlagEncoder(String propertiesStr) {
        this(new PMap(propertiesStr));
    }

    public SecondMapcBikeFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
